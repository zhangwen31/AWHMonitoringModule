#
#  Be sure to run `pod spec lint AWHMonitoringModule.podspec' to ensure this is a
#  确保运行“pod spec lint AWHMonitoringModule.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangwen31/AWHMonitoringModule"
  ...
  s.source       = { :git => "https://github.com/zhangwen31/AWHMonitoringModule.git", :tag => "#{s.version}" }
...
#  s.source_files  = "AWHMonitoringModule/**/*.{h,m,swift}"
#  # s.exclude_files = "Classes/Exclude"   #排除文件
#
#  s.public_header_files = "AWHMonitoringModule/**/*.h"
  
  s.vendored_frameworks = ['AWHMonitoringModule.framework']
  s.source_files = 'AWHMonitoringModule.framework/Headers/*h'
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHMonitoringModuleLocalizable.bundle']
